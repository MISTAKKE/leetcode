            ...
            for (int y = 0; y < board[0].size(); ++y) {
                ...
                for (int i = -1; i < 2; ++i)
                    for (int j = -1; j < 2; ++j) {
                        int newx = x + i;
                        int newy = y + j;
                        if (valid(board, newx, newy) &&
                            (board[newx][newy] == 'E' || (board[newx][newy] > 0 && board[newx][newy] < 8))) {
...
int main() {
    Solution A;
    vector<vector<char>> vec{{'B', 'B', 'B', 'B', 'B', 'B', '1', 'E'}, {'B', '1', '1', '1', 'B', 'B', '1', 'M'},
    ...
    vector<vector<char>> r{{'B', 'B', 'B', 'B', 'B', 'B', '1', '1'}, {'B', '1', '1', '1', 'B', 'B', '1', 'M'},
                           {'1', '2', 'M', '1', 'B', 'B', '1', '1'}, {'M', '2', '1', '1', 'B', 'B', 'B', 'B'},
                           {'1', '1', 'B', 'B', 'B', 'B', 'B', 'B'}, {'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B'},
                           {'B', '1', '2', '2', '1', 'B', 'B', 'B'}, {'B', '1', 'M', 'M', '1', 'B', 'B', 'B'}};
    show(r);
